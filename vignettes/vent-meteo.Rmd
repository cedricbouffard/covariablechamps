...
```{r rose-simple, eval = FALSE}
tracer_rose_vents(rose)
```

### Rose des vents empilée

```{r rose-stackee, eval = FALSE}
tracer_rose_vents_stacked(rose)
```

## Direction dominante

```{r direction-dominante, eval = FALSE}
...
- [Documentation API](https://power.larc.nasa.gov/api/application/windrose/point)
