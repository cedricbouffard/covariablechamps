---
title: "Extraction des Covariables Terrain avec covariablechamps"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Extraction des Covariables Terrain}
...
Avant d'installer ce package, assurez-vous d'avoir installé le package `rgeomorphon` qui n'est pas sur CRAN:
...
Par défaut, les données sont reprojetées en **EPSG:2949** (NAD83(CSRS) / Québec Lambert), le système de coordonnées officiel du Québec. Vous pouvez changer cela avec le paramètre `epsg`:
...
Si votre polygone n'a pas de système de coordonnées défini, WGS84 (EPSG:4326) est assigné automatiquement:
...
- [Ressources naturelles Canada - LiDAR](https://www.nrcan.gc.ca/science-and-data/science-and-research/earth-sciences/geomatics/canadas-elevation-data/llid-high-resolution-dem)
