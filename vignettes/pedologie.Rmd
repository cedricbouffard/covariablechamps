...
Le package facilite l'accès aux données de la couverture pédologique du Québec via la fonction `telecharger_pedologie_quebec()`. Elle utilise `vsicurl` pour ne télécharger que les données nécessaires à l'emprise de votre champ.

```{r telechargement-quebec, eval = FALSE}
