...
- [`telecharger_lidar_ponctuel()`](https://votrenom.github.io/covariablechamps/reference/telecharger_lidar_ponctuel.md)
...
- [`vider_cache_lidar()`](https://votrenom.github.io/covariablechamps/reference/vider_cache_lidar.md)
...
- [`visualiser_orientation()`](https://votrenom.github.io/covariablechamps/reference/visualiser_orientation.md)
...
- [`extraire_ligne_centrale_haies()`](https://votrenom.github.io/covariablechamps/reference/extraire_ligne_centrale_haies.md)
  : Extraire la ligne centrale d'un rectangle de haie
- [`calculer_zones_vent_spline()`](https://votrenom.github.io/covariablechamps/reference/calculer_zones_vent_spline.md)
  : Calculer les zones d'influence du vent sur les haies avec une forme
  de demi-lune
- [`rasteriser_zones_gradient()`](https://votrenom.github.io/covariablechamps/reference/rasteriser_zones_gradient.md)
  : Rasteriser les zones de vent avec le facteur H minimum par pixel
- [`rasteriser_zones_gradient_v2()`](https://votrenom.github.io/covariablechamps/reference/rasteriser_zones_gradient_v2.md)
  : Rasteriser les zones de vent avec le facteur H minimum par pixel
  (version corrigée)
...
- [`visualiser_distance_arbres()`](https://votrenom.github.io/covariablechamps/reference/visualiser_distance_arbres.md)
  : Visualiser la distance aux arbres
- [`visualiser_distances_vent()`](https://votrenom.github.io/covariablechamps/reference/visualiser_distances_vent.md)
  : Visualiser les distances amont/aval
- [`simuler_vitesse_vent_simple()`](https://votrenom.github.io/covariablechamps/reference/simuler_vitesse_vent_simple.md)
...
- [`calculer_distances_vent()`](https://votrenom.github.io/covariablechamps/reference/calculer_distances_vent.md)
  : Calculer les distances aux arbres selon la direction du vent
- [`calculer_fetch_vent()`](https://votrenom.github.io/covariablechamps/reference/calculer_fetch_vent.md)
  : Créer une carte de fetch de vent avec effet directionnel
  (elliptique)
- [`visualiser_fetch()`](https://votrenom.github.io/covariablechamps/reference/visualiser_fetch.md)
  : Visualiser le fetch de vent
- [`distance_arbres-package`](https://votrenom.github.io/covariablechamps/reference/distance_arbres-package.md)
...
- [`tracer_carte_vent()`](https://votrenom.github.io/covariablechamps/reference/tracer_carte_vent.md)
...
- [`calculer_ombrage()`](https://votrenom.github.io/covariablechamps/reference/calculer_ombrage.md)
  : Calculer l'ombrage d'une parcelle à partir du LiDAR et de la
  position du soleil
- [`calculer_ombrage_periode()`](https://votrenom.github.io/covariablechamps/reference/calculer_ombrage_periode.md)
  : Calculer l'ombrage sur une periode de dates
- [`calculer_ombrage_visualisation()`](https://votrenom.github.io/covariablechamps/reference/calculer_ombrage_visualisation.md)
...
- [`obtenir_rose_vents()`](https://votrenom.github.io/covariablechamps/reference/obtenir_rose_vents.md)
  : Obtenir la rose des vents depuis NASA POWER
- [`tracer_rose_vents()`](https://votrenom.github.io/covariablechamps/reference/tracer_rose_vents.md)
  : Créer un graphique radar de la rose des vents
- [`tracer_rose_vents_stacked()`](https://votrenom.github.io/covariablechamps/reference/tracer_rose_vents_stacked.md)
...
- [`proba_et_classement_serie_quota_ilr()`](https://votrenom.github.io/covariablechamps/reference/proba_et_classement_serie_quota_ilr.md)
...
- [`extraire_covariables_complet()`](https://votrenom.github.io/covariablechamps/reference/extraire_covariables_complet.md)
  : Extraire l'ensemble des covariables pour un champ
- [`visualiser_covariables()`](https://votrenom.github.io/covariablechamps/reference/visualiser_covariables.md)
